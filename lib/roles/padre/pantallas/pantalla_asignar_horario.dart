...
class _PantallaAsignarHorarioState extends State<PantallaAsignarHorario> {
 ...
 Future<void> calcularProrrateo() async {
  ...
  // ==========================================================
  // CONFIRMAR Y GUARDAR (ASIGNACIÓN + CARRITO + ESTADO)
  // ==========================================================
Future<void> confirmarYGuardar() async {
  ...
  Navigator.of(context).pop(true);   // REGRESA A ESTUDIANTES REGISTRADOS
}
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            ...
            "⚠️ **ADVERTENCIA IMPORTANTE:** Si necesita cambiar el horario después de la confirmación, deberá **contactar a soporte** para gestionarlo. ¡Revise bien!",
          ),
          actions: [
            TextButton(
              onPressed: () {
                // Elige editar, se queda en la pantalla actual
                Navigator.of(context).pop();
              },
              child: const Text("Editar (Quedarme aquí)"),
            ),
              ElevatedButton(
                onPressed: () async {
                  await confirmarYGuardar();
                },
...
// ... (El resto del método build es el mismo)
  return Scaffold(
   appBar: AppBar(
